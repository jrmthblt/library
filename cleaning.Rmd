...
docs <- tm_map(docs, removeWords, c("...", "d'", "l'", "resume", "science-fiction", "où", "plus", "tome", "serie", "roman", "romans", "collection", "livre", "gerard", "dirigee", "prix"))
...
# sfWords <- paste(dfBookSummaries[dfBookSummaries$genre=='Science-Fiction','text'],collapse=' ') # on concatene tout le texte
# wordsFreq <- data.frame(sort(table(strsplit(sfWords,"\\s+")),decreasing=TRUE)) # on compte chaque mot, le motif entre guillemet veut dire qu'on coupe la chaine de caractère quelque soit le nombre d'espaces entre les mots
# head(wordsFreq)
```
