...
ANCIEN CODE MULTICLASSE, QUI ENCOURAGE A TESTER EN BINAIRE SUR CHACUNE DES CLASSES CAR LITTERATURE VAMPIRISE LA PREDICTION.
stephanie.combes@gmail.com pour des questions

TODO : voir à enlever les documents de la collection Littérature et refaire les modèles. Catégorie fourre-tout.

```{r ancien code multiclasse}
...
rpartGridSearch <- expand.grid(cp = seq(0, 0.05, 0.001))
