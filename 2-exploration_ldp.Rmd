...
dim(dtmTf_m_filtered) # Caret a conservé 134 variables sur les 39584 ! Et on voit qu'il a conservé beaucoup de stop words... il faut refaire une passe complète.
...
# OU :
dtmTf_m_filtered <- dtmTf_m_filtered[-c(68, 1210, 2570, 3923, 4926),]
...
dfBookSummaries <- dfBookSummaries[-c(68, 1210, 2570, 3923, 4926),]
```
